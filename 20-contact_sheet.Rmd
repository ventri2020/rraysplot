...
contact_sheet <- function(patient, image, scat, vsat) {
  ...
  p2 <- rraysplot::plot2_array2d(vsat, scat, title = "SCAT", title_size = 9, alpha = 0.8)
  p3 <- rraysplot::plot2_array2d(vsat, vsat, title = "VSAT", title_size = 9, alpha = 0.6)
...
```{r contact-sheets, fig.show="hold", fig.asp = 0.24, out.width="100%"}
contact_sheets()
```
