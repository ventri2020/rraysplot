...
## Generate images of all data

TODO: mri + mask, mri + scat, mri + vsat
...
```{r}
set.seed(202011)
test <- sort(sample(1:80, 10, replace = FALSE))
train <- sort((1:80)[-test])
str(train)
str(test)
```
...
```{r}
# usethis::use_data_raw(name = "fat80_768x384")
