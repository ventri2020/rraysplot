...
```{r figures-bhist1, fig.show="hold", fig.asp = 1, out.width="50%"}
invisible(plot(mri_list[[1]]))
bhistogram(as.array(mri_list[[1]]))
```

```{r figures-bhist2, fig.show="hold", fig.asp = 1, out.width="50%"}
# scat_list <- scat_list * mask_list
...
## Important! Remove background artifacts
...
```{r}
lobstr::obj_sizes(mri_train, mask_train, scat_train, vsat_train)
```
...
plot2_array2d(
  mri_train[29,,], mask_train[29,,],
  alpha = 0.4,
  title = dimnames(mri_train)[[1]][[29]],
  title_size = 24
)
plot2_array2d(
  mri_train[29,,],
...
plot2_array2d(
  mri_train[29,,], scat_train[29,,],
  title = dimnames(mri_train)[[1]][[29]],
  title_size = 24
)
plot2_array2d(
  mri_train[29,,], vsat_train[29,,],
  title = dimnames(mri_train)[[1]][[29]],
  title_size = 24
)
```
